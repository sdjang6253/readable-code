...
public class MinesweeperGame {
    ...
    private static final Integer[][] NEARYBY_LAND_MINE_COUNTS = new Integer[BOARD_ROW_SIZE][BOARD_COL_SIZE];
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            String cellInput = getCleeInputFromUser(scanner);
    ...
    private static void actOnCell(String cellInput, String userActionInput) {
        ...
        if (doesUserChooseToOpenCell(userActionInput)) {
            if (isLandMineCell(selectedRowIndex, selectedColIndex)) {
                BOARD[selectedRowIndex][selectedColIndex] = LANDMINE_SIGN;
    ...
    private static String getCleeInputFromUser(Scanner scanner) {
        ...
        for (int row = 0; row < BOARD_ROW_SIZE; row++) {
            for (int col = 0; col < BOARD_COL_SIZE; col++) {
                ...
                if (!isLandMineCell(row, col)) {
                    ...
                    NEARYBY_LAND_MINE_COUNTS[row][col] = count;
                    continue;
                }
                NEARYBY_LAND_MINE_COUNTS[row][col] = 0;
            }
        }
    }
    ...
    private static void open(int row, int col) {
        ...
        if (NEARYBY_LAND_MINE_COUNTS[row][col] != 0) {
            BOARD[row][col] = String.valueOf(NEARYBY_LAND_MINE_COUNTS[row][col]);
            return;
        } else {
